...
-- Selecionando os dados da tabela cadastro --
...
-- Selecionando os dados da tabela usuário --
select * from usuario;
...
-- Selecionando os dados da tabela fazenda --
select * from fazenda;

-- Criando Tabela Dados Históricos --
...
-- Selecionando os dados da tabela Dados Históricos --
select * from dados_historicos;

-- Criano Tabela Sensor -- 
create table sensor (
...
-- Selecionando os dados da tabela Sensor --
select * from sensor; 
...
update usuario set idUsuario = 1 where fkCadastro_usuario = 
